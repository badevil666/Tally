...
const CategoryModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'limit': PropertySchema(id: 3, name: r'limit', type: IsarType.double),
...
const _CategoryModeltypeEnumValueMap = {'fixed': 0, 'variable': 1};
const _CategoryModeltypeValueEnumMap = {
  0: CategoryType.fixed,
  1: CategoryType.variable,
};
...
extension CategoryModelQueryFilter
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
  limitEqualTo(double value, {double epsilon = Query.epsilon}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'limit',
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByLimitDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByLimitDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'limit', Sort.desc);
    });
  }
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, double, QQueryOperations> limitProperty() {
    return QueryBuilder.apply(this, (query) {
