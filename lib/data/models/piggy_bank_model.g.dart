...
extension GetPiggyBankEntryModelCollection on Isar {
  IsarCollection<PiggyBankEntryModel> get piggyBankEntryModels =>
      this.collection();
}

const PiggyBankEntryModelSchema = CollectionSchema(
  ...
  deserializeProp: _piggyBankEntryModelDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
...
void _piggyBankEntryModelSerialize(
  PiggyBankEntryModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
PiggyBankEntryModel _piggyBankEntryModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = PiggyBankEntryModel();
...
P _piggyBankEntryModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _piggyBankEntryModelGetId(PiggyBankEntryModel object) {
  return object.id;
}
...
extension PiggyBankEntryModelQueryWhereSort
    on QueryBuilder<PiggyBankEntryModel, PiggyBankEntryModel, QWhere> {
  QueryBuilder<PiggyBankEntryModel, PiggyBankEntryModel, QAfterWhere> anyId() {
...
extension PiggyBankEntryModelQueryProperty
    on QueryBuilder<PiggyBankEntryModel, PiggyBankEntryModel, QQueryProperty> {
  QueryBuilder<PiggyBankEntryModel, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<PiggyBankEntryModel, double, QQueryOperations> amountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'amount');
    });
  }

  QueryBuilder<PiggyBankEntryModel, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'date');
    });
  }

  QueryBuilder<PiggyBankEntryModel, String, QQueryOperations> noteProperty() {
    return QueryBuilder.apply(this, (query) {
